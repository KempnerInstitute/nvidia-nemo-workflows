...
def get_args():
    ...
    parser.add_argument("--tokenizer_library", type=str, required=True, help=""".""")
    parser.add_argument("--tokenizer_type", type=str, required=True,  help=""".""")
...
if __name__ == "__main__":
    ...
    data = llm.PreTrainingDataModule(
        ...
        tokenizer=get_nmt_tokenizer(args.tokenizer_library, args.tokenizer_type)
    )
