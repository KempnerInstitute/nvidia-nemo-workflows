...
def convert(args):
    ...
    if 'tokenizer_model' not in hf_config:
        if hf_config['num_hidden_layers'] == 32:
            model.cfg.tokenizer.update(type='meta-llama/Llama-2-7b-hf')
        elif hf_config['num_hidden_layers'] == 40:
            model.cfg.tokenizer.update(type='meta-llama/Llama-2-13b-hf')
        elif hf_config['num_hidden_layers'] == 80:
            model.cfg.tokenizer.update(type='meta-llama/Llama-2-70b-hf')
